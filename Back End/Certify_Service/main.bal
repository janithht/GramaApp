...
function addCertificateRequest(NewRequest req) returns int|error {
    ...
    sql:ExecutionResult result = check certifyDb->execute(`
        INSERT INTO certificaterequest (division_id, NIC, email, phoneNo, id_check, address_check, police_check, status,no,street1,street2,city,postalcode,date_submitted)
        VALUES (${req.division_id},${req.NIC}, ${req.email},${req.phoneNo} ,${exist_Id}, ${address_check}, ${police_check}, ${request_status},${req.no},${req.street1},${req.street2},${req.city},${req.postalcode},${date})`);
